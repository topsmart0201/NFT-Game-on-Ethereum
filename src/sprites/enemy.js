...
import { C_ENEMY_ATTRIBUTES } from "../lib/config";
...
export default class Enemy extends Phaser.GameObjects.Sprite {
    ...
    constructor(config) {
        ...
        this.body.setBounceY(C_ENEMY_ATTRIBUTES.BounceY);
        this.body.setGravityY(C_ENEMY_ATTRIBUTES.Gravity);
    ...
    deathRegister() {
        //register this enemy as dead so it is not added to future instances of this level.
